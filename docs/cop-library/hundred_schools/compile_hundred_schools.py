...
与 TDCA核心 / 兵法 / 博弈论 / 机制设计 / 场景 并列, 但本库是 **中文化合基库**:
  - 道德经 (道家) = 首个 operand, 后续作 "中国文化 ⊕ 马克思主义" 化合的中方基协议
...
HS = [
    {
        ...
        "core": "《道德经》是人类'顺势·辩证·守弱·不争'智慧的范式化: 以'道'为万物根源与运行规律, "
                ...
                "(轻扰动稳序)、见素抱朴(删繁归本)。它是'中文化合基库'首个 operand, 后续可作'中国文化 ⊕ 马克思主义'"
...
if __name__ == "__main__":
    ...
    print("中文化合基库 operand: HS-DAO-20260815-01 (道德经) — 后续作 中国文化⊕马克思主义 化合中方基协议")
    print("===== 编译完成 =====")
